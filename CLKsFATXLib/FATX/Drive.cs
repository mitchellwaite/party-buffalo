    ...
    public class Drive
    {
        ...
        public ulong RemainingSpace()
        {
            ...
            if (Remaining == ~0UL)
            {
                ...
                {
                    Remaining += new PartitionFunctions(this, Partitions[i]).GetFreeSpace();
                }
            }
            return Remaining;
        }
        ...
        public ulong GetPartitionRemainingStorage(Folder Partition)
        {
        ...
        public bool IsDeviceHandleGood()
        {
            try
            {
                byte[] temp = new byte[0x200];
                Stream().Read(temp, 0, 0x200);
